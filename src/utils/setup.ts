...
import addToWatchlistEndpoint from "../routes/WRITE/watchlist/addToWatchlist";
import deleteFromWatchlistEndpoint from "../routes/WRITE/watchlist/deleteFromWatchlist";
import getCategoriesEndpoint from "../routes/READ/getCategories";
import categoryAddEndpoint from "../routes/WRITE/categoryModification/addCategory";
import categoryUpdateEndpoint from "../routes/WRITE/categoryModification/updateCategory";
import categoryDeleteEndpoint from "../routes/WRITE/categoryModification/deleteCategory";
...
import videoDeleteEndpoint from "../routes/WRITE/videoModification/deleteVideo";
import videoAddEndpoint from "../routes/WRITE/videoModification/addVideo";
import videoUpdateEndpoint from "../routes/WRITE/videoModification/updateVideo";
import uploadFilesEndpoint from "../routes/WRITE/uploadFiles";
import updateUserPermissionsEndpoint from "../routes/WRITE/permissionModification/updateUserPermissions";
import updateUserVideoProgressEndpoint from "../routes/WRITE/videoProgressModification/updateUserVideoProgress";
